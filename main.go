...
func rangeGet(cursorFloor string, cursorCiel string) GraphRes {
	...
	features := map[string]bool{
		...
		// https://pbs.twimg.com/media/GZqWwbraAAAxFri?format=jpg&name=small
	...
	// Rate limited! Take a break, then retry the request.
...
func main() {
	...
	i := 0
	// TODO: This is sloppy. Once you get to the end, the cursor will have some value to
	// indicate that no more pages are available. This should be a while loop that checks
	// for this.
	for i < 1000 {
